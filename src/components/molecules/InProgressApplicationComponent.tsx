...
export default function InProgressApplicationComponent({ lockApplication }: Props) {
    ...
    const getApplicationDataList = useCallback(async () => {
        let response = await getApplicationList(page, 5, ApplicationResponseStatus.REFERRED);

...
export default function RejectedApplicationComponent({ lockApplication }: Props) {
    ...
    const getApplicationDataList = useCallback(async () => {
        let response = await getDecisionMakerApplicationList(page, 5, 'rejected');
        console.log('decision maker rejected ', response);

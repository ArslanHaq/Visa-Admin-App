...
export default function DefferedApplicationComponent({ lockApplication }: Props) {
    ...
    const getApplicationDataList = useCallback(async () => {
        let response = await getApplicationList(page, 5, ApplicationResponseStatus.DEFFERED);

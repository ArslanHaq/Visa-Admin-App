...
export default function ReadyDecisionApplicationComponent({ lockApplication }: Props) {
    ...
    const getApplicationDataList = useCallback(async () => {
        let response = await getDecisionMakerApplicationList(page, 5, 'ready for decision');

...
import { getApplicationList, getDecisionMakerApplicationList } from "@/server/application";
...
export default function ApprovedApplicationComponent({ lockApplication }: Props) {
    ...
    const getApplicationDataList = useCallback(async () => {
        let response = await getDecisionMakerApplicationList(page, 5, 'approved');

...
import ViewDecisionMakerApplicationCompleteComponent from "@/components/molecules/ViewDecisionMakerApplicationCompleteComponent";
import ViewVerifierApplicationCompleteComponent from "@/components/molecules/ViewVerifierApplicationCompleteComponent";
...
export default async function ApplicationReviewPage(
    ...
    return (
        <div>
            <ViewDecisionMakerApplicationCompleteComponent
